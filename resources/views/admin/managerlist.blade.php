        ...
        <div class="col mb-3">
          <div class="card">
            ...
            <div class="card-footer">
              <button href="/protfolio/details/{{$user->id}}" class="btn btn-light btn-sm bg-white has-icon btn-block" type="button">Follow<i class="material-icons">Details</i></button>
